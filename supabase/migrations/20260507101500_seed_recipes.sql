-- Keep stable app-side IDs (recipe_id slugs) while recipes are stored in Postgres.
alter table public.recipes
add column if not exists source_id text;

create unique index if not exists recipes_source_id_key on public.recipes (source_id);

-- One-time seed from local `data/recipes.ts`.
insert into public.recipes (source_id, doc)
values
  (
    'ofe-oha',
    '{
      ...
      "instructions_en":["Wash and pick oha leaves gently; tear, do not cut finely.","Boil cocoyam until soft, pound or blend into a smooth paste.","Simmer meat and stockfish in seasoned broth.","Thicken with cocoyam paste; adjust salt carefully for heart health.","Add palm oil in moderation; stir in uziza if using.","Fold in oha leaves last; cook briefly to keep aroma."],
      "instructions_ig":["Sacha ahịhịa oha nwayọọ; dọkpụ, echeghị ka a sie ya nke nnukwu.","See ede ruo mgbe ọ dị nro, kụọ ma ọ bụ mee ka ọ dị nro.","See anụ na okporoko n''ọsọ dị mma.","Jiri mgbam ede mee ka ọ dị sara; tụgharịa nnuofe nwayọọ maka obi.","Tinye mmanụ aṅụ n''ụzọ dị obere; kwagide uziza ọ bụrụ na ị na-eji ya.","Kwụsị ị tinye ahịhịa oha ikpeazụ; see obere ka isi dị mma."],
  ...
  (
    ...
    '{
      ...
      "instructions_en":["Parboil bitter leaf until bitterness is mellowed.","Prepare cocoyam paste as thickener.","Cook meats until tender; add crayfish and seasoning.","Combine paste and leaves; simmer to marry flavors."],
      "instructions_ig":["See onugbu ka ọnwụnwu dị obere.","Mee mgbam ede.","See anụ ruo mgbe ọ dị mfe; tinye eriokpo.","Jikọta ede na ahịhịa; see ka ọ dị ụtọ."],
  ...
  (
    ...
    '{
      ...
      "instructions_en":["Bring water to a gentle boil in a pot.","Stir in fermented paste in batches, beating to remove lumps.","Turn until smooth and elastic; wrap in plastic to rest."],
      "instructions_ig":["See mmiri na ite.","Kwakọta akpu n''akụkụ, kụọ ka lumps fọdụrụ.","Kwụsị mgbe ọ dị sọsọ; chọọ ya ka ọ zuru ike."],
  ...
  (
    ...
    '{
      ...
      "instructions_en":["Boil plantains until very soft.","Pound or use food processor with minimal water.","Shape gently; serve warm with soup of choice."],
      "instructions_ig":["See unere ruo mgbe ọ dị nro.","Kụọ ma ọ bụ jiri ngwa achị achị.","Mee ya ka ọ dị mma; nye ya na ofe ị họrọ."],
  ...
  (
    ...
    '{
      ...
      "instructions_en":["Soak abacha until tender; drain well.","Season ugba lightly; mix with abacha.","Dress with warmed palm oil; garnish with utazi."],
      "instructions_ig":["Tụọ abacha ruo mgbe ọ dị mfe; chụọ ya.","Tụgharịa ugba; jikọta ya na abacha.","Jiri mmanụ aṅụ dị ọkụ mee ya; tinye utazi."],
  ...
  (
    ...
    '{
      ...
      "instructions_en":["Dice yam small; boil in broth until very soft.","Mash partially for easy chewing.","Fold in vegetables and fish; simmer gently."],
      "instructions_ig":["Bee ji obere; see na ọsọ ruo mgbe ọ dị nro.","Kụọ obere ka e si eri ya mfe.","Tinye ahịhịa na azụ; see nwayọọ."],
